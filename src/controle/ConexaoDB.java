...
public class ConexaoDB {
    ...
    private String caminho = "jdbc:hsqldb:hsql://localhost/myServerDB";
    ...
    public void iniciaServidor(){	
    	...
    	HsqlProperties p = new HsqlProperties();
    	 p.setProperty("server.database.0","file:myServerDB");
    	 try {
    	 p.setProperty("server.dbname.0","myserverdb");
    	 } catch (Exception e) {
    ...
    public void preparaTabelas(){
    	...
    	try{
        		...
        		this.executaSql("create table if not exists tb_clientes(nome varchar(100),cpf varchar(14),telefone varchar(16),email varchar(60),apolice varchar(20),vencimento date);");
